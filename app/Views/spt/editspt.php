                    ...
                    <div class="card-body row">
                      <div class="col">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col">
                            <input class="form-control <?= isset($errors['spt_lokasi']) ? 'is-invalid' : null ; ?>" type="text" name="spt_lokasi" placeholder="Tempat Tujuan Misal : Badan/Dinas/Kementerian beserta Alamatnya" id="spt_lokasi" value="<?= old('spt_lokasi')  ? old("spt_lokasi") : $spt->spt_lokasi ?>">
                              <div class="invalid-feedback">
