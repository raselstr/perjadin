                          ...
                          <div class="col">
                            <select name="spt_pptk" id="spt_pptk" class="form-control <?= isset($errors['spt_pptk']) ? 'is-invalid' : null ; ?>">
                              ...
                              <?php foreach ($pptks as $key => $pptk) { ?>
                                <option value="<?= $pptk->pegawai_id ?>" <?= $pptk->pegawai_id == 'spt_pptk' ? 'selected':null?>><?= $pptk->pegawai_nama; ?></option>
                              <?php } ?>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col">
                            <select name="spt_transport" id="spt_transport" class="form-control <?= isset($errors['spt_transport']) ? 'is-invalid' : null ; ?>">
                              ...
                              <option value="Angkutan Umum"<?= old('spt_transport') == "Angkutan Umum Darat" ? 'selected':null?>>Angkutan Umum</option>
